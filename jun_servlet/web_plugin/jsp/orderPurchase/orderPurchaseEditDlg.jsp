...
<script type="text/javascript">
	...
	$(function() {
		 $dg = $("#dg");
		 $dg.datagrid({
			 url :"orderPurchaseController.do?method=findPurchaseOrderLineList&orderPurchaseId="+$("#tempId").val(),
			width : 'auto',
		 ...
		 $cb = $("#suplierId");
		 $cb.combogrid({
			url : "supController.do?method=findSuplierListNoPage",
			width : 171,
			panelWidth: 400,
			panelHeight: 300,
			rownumbers:true,
			...
			columns : [ [ {field : 'myid',title : '供应商编码',width : 150},
			              {field : 'name',title : '供应商名称',width : 150}
			            	  ...
			            	  $("#suplierContact").combobox({
			          			width:171,
			        			url:"supController.do?method=findSuplierContactListCombobox&suplierId="+rowData.suplierId,
			        			valueField: 'name',
			        			textField: 'name',
		...
		$("#form").form({
			url :"orderPurchaseController.do?method=persistenceOrderPurchase",
			onSubmit : function() {
	...
	<input name="tempId" id="tempId"  type="hidden" value="<%=request.getParameter("tempId")==null?"":request.getParameter("tempId")%>"/>
		<form id="form" method="post">
				<div title="基本资料" data-options="iconCls:'icon-cstbase'" style="padding:10px">
						<fieldset>
							<legend><img src="css/extend/fromedit.png" style="margin-bottom: -3px;"/>基本资料编辑</legend>
							...
							<input name="deleted" id="deleted"  type="hidden"/>
							 <table class="table">
								 ...
								 <tr>
									...
									<th>联系人</th>
									<td><input id="suplierContact" name="suplierContact" type="text" class="easyui-textbox easyui-validatebox"/><img src="css/extend/area.png" style="margin-left:2px;margin-bottom: -5px;cursor: pointer;" onclick="addAreaOpenDlg();"/></td>
									<th>电话</th>
								  ...
								  <tr>
									...
									<th>采购部门</th>
									<td><input id="buyerOrganizationId" name="buyerOrganizationId" type="text" class="easyui-textbox easyui-validatebox"/><input id="buyerOrganizationName" name="buyerOrganizationName" type="hidden"/><img src="css/extend/area.png" style="margin-left:2px;margin-bottom: -5px;cursor: pointer;" onclick="addAreaOpenDlg();"/></td>
									<th>币别</th>
