...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function initMenu(){
			...
			$.post("systemController.do?method=findAllFunctionList", {userName:"1"}, function(rsp) {
 ...
 <body class="easyui-layout">
	<div data-options="region:'north',border:false" style="height:60px;background:white;padding:0px;overflow: hidden;"  href="layout/north.jsp"></div>
