...
package com.jun.plugin.common.hibernate4;
...
public abstract class AbstractHibernateTree<T extends Number> implements HibernateTree<T> {
	...
	/**   
	 * @return  
	 * @see com.jun.plugin.common.hibernate4.HibernateTree#getLftName()  
	 */
	...
	/**   
	 * @return  
	 * @see com.jun.plugin.common.hibernate4.HibernateTree#getRgtName()  
	 */
	...
	/**   
	 * @return  
	 * @see com.jun.plugin.common.hibernate4.HibernateTree#getParentName()  
	 */
