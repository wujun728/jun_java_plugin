package com.jun.plugin.spring.dbutil.aop;
...
import com.jun.plugin.spring.dbutil.datasource.DynamicDataSource;

/**
 * 有{@link com.jun.plugin.spring.dbutil.aop.DataSourceChange}注解的方法，调用时会切换到指定的数据源
 * 
 * @author tanghd
 *
 */
