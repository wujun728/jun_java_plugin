...
public class MailDemo {
	...
	public static void sendHtmlAndImgEmail() throws Exception {
		...
		// ������Դ
		DataSource ds = new FileDataSource(MailDemo.class.getResource("1.jpg").getPath());
	...
	public static void sendHtmlWithImgAndAttacheEmail() throws Exception {
		...
		DataSource fileDs = new FileDataSource(URLDecoder.decode(MailDemo.class.getResource("�û���֪.doc").getPath(), "UTF-8"));
