package io.github.wujun728.common.aop.aspectj;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(io.github.wujun728.common.aop.annotation.LogAnnotation)")
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        log.info("Ip{}，接口地址{}，请求方式{}，入参：{}", ServletUtil.getClientIP(request,null), request.getRequestURL(), request.getMethod(), params);
        //用户名
