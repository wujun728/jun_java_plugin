...
public class ConstantsInitListener implements ApplicationListener<ApplicationContextInitializedEvent>, Ordered {
    ...
    public void onApplicationEvent(ApplicationContextInitializedEvent applicationContextInitializedEvent) {
        ...
        com.jun.plugin.groovy.listener.ConstantContext.putConstant(DATABASE_URL_NAME, dataSourceUrl);
        com.jun.plugin.groovy.listener.ConstantContext.putConstant(DATABASE_DRIVER_NAME, environment.getProperty("spring.datasource.driver-class-name"));
        com.jun.plugin.groovy.listener.ConstantContext.putConstant(DATABASE_USER_NAME, dataSourceUsername);
