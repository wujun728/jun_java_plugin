...
public class JavaClassExecutor {
	...
	public static String execute(byte[] classByte, String systemIn) {
		...
		// 3. 调用ClassModifier#modifyUTF8Constant修改
		byte[] modifyBytes = cm.modifyUTF8Constant("java/lang/System", "io/github/wujun728/compile/execute/HackSystem");
		modifyBytes = cm.modifyUTF8Constant("java/util/Scanner", "io/github/wujun728/compile/execute/HackScanner");
	...
	public static String execute(StringSourceCompilerExtend compilerExtend, String systemIn) {
		...
		for (JavaFileObject javaFileObject : fileObjectMap.values()) {
			try {
				...
				byte[] modifyBytes = cm.modifyUTF8Constant("java/lang/System", "io/github/wujun728/compile/execute/HackSystem");
				modifyBytes = cm.modifyUTF8Constant("java/util/Scanner", "io/github/wujun728/compile/execute/HackScanner");
				modifyBytes = cm.modifyUTF8Constant("java/util/ArrayList", "io/github/wujun728/compile/execute/HackArrayList");
				modifyBytes = cm.modifyUTF8Constant("java/util/HashMap", "io/github/wujun728/compile/execute/HackHashMap");
		...
		try {
			...
			if(StringUtils.isEmpty(systemIn)){
				...
				Object o = clazz.newInstance();
				SpringUtils.autowireBean(o);
				//SpringUtils.getBean(o.getClass());
