...
//        List<Record> result = Db.findAllRecord("biz_mail");
//        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
//    }
//
//    @Test
...
//        sql.setGroup("test11");
//        Integer result = Db.saveEntity(sql);
//        StaticLog.info(String.valueOf(result));
//    }
//
//    @Test
...
//        Integer result = Db.updateEntity(sql);
//        StaticLog.info(String.valueOf(result));
//    }
//
//
...
////        sql.setGroup("test11");
//        sql.setId(1243333565);
//        Integer result = Db.deleteEntity(sql);
//        StaticLog.info(String.valueOf(result));
//    }
//
//
...
//        ApiSql result = (ApiSql) Db.findObjectById(ApiSql.class,1243333563,"test1622823114");
//        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
//    }
//    @Test
//    public void testGetByParams() throws Exception {
//        ApiSql result = (ApiSql) Db.findObjectByParams(ApiSql.class,new String[]{"id","sql_id"},1243333563,"test1622823114");
//        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
//    }
//
//    @Test
