...
public class DbTest {
    ...
    public void testFindBySql2() throws Exception {
        List<Record> result = Db.findBySql(" select * from biz_mail where id = ? ",1);
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }

    @Test
    public void testFindAll() throws Exception {
        List<Record> result = Db.findAll("biz_mail");
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
    ...
    public void testDeleteByIds() throws Exception {
        Boolean result = Db.deleteByIds("api_sql", "id,sql_id", "2","getBizTests111");
        StaticLog.info(String.valueOf(result));
    }

    @Test
    public void testFind2() throws Exception {
        List<Record> result = Db.findBySql(" select * from api_sql where 1=1 and sql_id = ?", "getBizTests");
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
    ...
    public void testQuery() throws Exception {
        List result = Db.query(" select * from api_sql where sql_id = ?", "queryTest");
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
    ...
    @Test
    public void testQueryForBeanList() throws Exception {
        List<ApiSql> result = Db.queryBeanList(ApiSql.class," select * from api_sql ",  null);
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
...
//        sql.setGroup("test11");
    ...
    public void testGetById() throws Exception {
        ApiSql result = (ApiSql) Db.getObjectById(ApiSql.class,1243333563,"test1622823114");
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
    @Test
    public void testGetByParams() throws Exception {
        ApiSql result = (ApiSql) Db.getObjectByParams(ApiSql.class,new String[]{"id","sql_id"},1243333563,"test1622823114");
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }

    @Test
    public void testQueryAll() throws Exception {
        List result = Db.queryAll(ApiSql.class);
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
    ...
    public void testQueryPage() throws Exception {
        Page result = Db.use().queryPage(ApiSql.class, 1, 10);
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
    @Test
    public void testQueryPage2() throws Exception {
        Page result = Db.queryPage(ApiSql.class, 1, 10, Maps.newHashMap());
        StaticLog.info(JSONUtil.toJsonPrettyStr(result));
    }
}
