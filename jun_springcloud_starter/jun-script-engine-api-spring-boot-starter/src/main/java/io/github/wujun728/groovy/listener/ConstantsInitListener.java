package io.github.wujun728.groovy.listener;
...
public class ConstantsInitListener implements ApplicationListener<ApplicationContextInitializedEvent>, Ordered {
    ...
    public void onApplicationEvent(ApplicationContextInitializedEvent applicationContextInitializedEvent) {
        ...
        ConstantContext.putConstant(DATABASE_URL_NAME, dataSourceUrl);
        ConstantContext.putConstant(DATABASE_DRIVER_NAME, environment.getProperty("spring.datasource.driver-class-name"));
        ConstantContext.putConstant(DATABASE_USER_NAME, dataSourceUsername);
