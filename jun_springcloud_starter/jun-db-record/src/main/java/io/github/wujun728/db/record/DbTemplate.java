...
public class DbTemplate {
    ...
    static DbTemplate init(String configName, DataSource dataSource) {
        DbTemplate dbPro = DbTemplate.cache.get(configName);
        if (dbPro == null) {
            dbPro = new DbTemplate();
            ...
            dbPro.setDialect(DbTemplate.getDialect(dbPro.getDataSource()));
            dataSourceMap.put(configName,dataSource);
            DbTemplate.registerRecord(dbPro.getDataSource());
            ...
            DbTemplate.cache.put(configName, dbPro);
        }
        return dbPro;
    }
