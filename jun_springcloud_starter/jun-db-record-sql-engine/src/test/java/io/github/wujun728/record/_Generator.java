...
//
//import io.github.wujun728.db.plugin.druid.DruidPlugin;
//import io.github.wujun728.db.record.dialect.MysqlDialect;
//import io.github.wujun728.db.record.generator.Generator;
//import io.github.wujun728.db.record.generator.TypeMapping;
//
...
//
//	/**
//	 * 在此统一添加不参与生成的 table。不参与生成的 table 主要有： 1：用于建立表之间关系的关联表，如 account_role 2：部分功能使用 Db + Record 模式实现，所涉及到的 table 也不参与生成
//	 */
