package com.jun.plugin.oa.entity;
...
//	private String procDefId;		//com.jun.plugin.oa.salary:1:127525-- 去掉，procDefId重新部署会改变的，保存这个id是无意义的
	
	@Column(name = "PROC_DEF_KEY")
	private String procDefKey;		//com.jun.plugin.oa.vacation
