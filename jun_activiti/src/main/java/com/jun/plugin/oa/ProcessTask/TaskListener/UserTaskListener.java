package com.jun.plugin.oa.ProcessTask.TaskListener;
...
import com.jun.plugin.oa.service.IUserTaskService;
...
public class UserTaskListener implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		String processDefinitionId = delegateTask.getProcessDefinitionId();	//com.jun.plugin.oa.vacation:8:30012
...
//		String processDefinitionName = processDefinition.getName();			//请假流程
		String processDefinitionKey = processDefinition.getKey();			//com.jun.plugin.oa.vacation
