package com.jun.plugin.tool.emoji;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

import com.jun.plugin.tool.emoji.encode.EmojiEncode;
import com.jun.plugin.tool.emoji.factory.EmojiFactory;
...
import com.jun.plugin.tool.emoji.transformer.EmojiTransformer;
