...
import static com.jun.plugin.tools.CollectionUtil.createLinkedList;
...
import com.jun.plugin.exceptions.ClassInstantiationException;
...
public class ClassLoaderUtil {
     ...
     * throws ClassInstantiationException 如果实例化失败
     */
    public static Object newInstance(String className, ClassLoader classLoader) throws ClassNotFoundException, com.jun.plugin.exceptions.ClassInstantiationException {
