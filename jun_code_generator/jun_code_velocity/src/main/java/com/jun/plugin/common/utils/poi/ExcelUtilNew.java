...
import com.jun.plugin.common.annotation.ExcelImport;
...
import com.jun.plugin.common.utils.TimeUuidUtil;
...
public class ExcelUtilNew<T> {
    private static final Logger log = LoggerFactory.getLogger(com.jun.plugin.common.utils.poi.ExcelUtil.class);
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = "" + filename;  // Global.getDownloadPath() + filename;
