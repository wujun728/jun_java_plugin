...
<#if fieldItem.isPrimaryKey==true>
    ...
    @RequestMapping(value = "/${classInfo.className?uncap_first}/page",method = {RequestMethod.GET,RequestMethod.POST})
    //@RequiresPermissions("${classInfo.className?uncap_first}:page")
