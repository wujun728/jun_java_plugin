<#if isWithPackage?exists && isWithPackage==true>package ${packageName}.resp;</#if>
...
public class ${classInfo.className}Resp extends BaseResp implements Serializable {
...
<#if isLombok?exists && isLombok==false>
    ...
    public ${classInfo.className}Resp() {}
}
