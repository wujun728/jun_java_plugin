...
//        String businessName = genTable.getBusinessName();
        //TODO: 2022/3/15
        // 注意，这里还是沿用className，保证统一
        String businessName = StringUtils.uncapitalize(className);
        ...
        if (template.contains("domain.java.vm")) {
            fileName = StringUtils.format("{}/pojo/{}PO.java", javaPath, className);
        }
        if (template.contains("sub-domain.java.vm") && StringUtils.equals(GenConstants.TPL_SUB, genTable.getTplCategory())) {
            fileName = StringUtils.format("{}/pojo/{}PO.java", javaPath, genTable.getSubTable().getClassName());
