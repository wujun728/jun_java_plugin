package com.jun.plugin.core.utils.log.dialect.log4j;

import org.apache.log4j.Level;
import org.apache.log4j.Logger;

import com.jun.plugin.core.utils.log.AbstractLocationAwareLog;
...
public class Log4jLog extends AbstractLocationAwareLog {
	...
	// ------------------------------------------------------------------------- Log
	@Override
	public void log(com.jun.plugin.core.utils.log.level.Level level, String format, Object... arguments) {
		log(level, null, format, arguments);
	}
	
	@Override
	public void log(com.jun.plugin.core.utils.log.level.Level level, Throwable t, String format, Object... arguments) {
		this.log(FQCN, level, t, format, arguments);
	}
	
	@Override
	public void log(String fqcn, com.jun.plugin.core.utils.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4jLevel;
		switch (level) {
			case TRACE:
