...
import com.jun.plugin.utils.web.BizUtil;
...
public class PropertiesReader {
    ...
    */
    ...
    public String getProperty(String key, String defaultValue) {
        if (BizUtil.checkNull(key).equals(""))
            return "";
        return BizUtil.checkNull(properties.getProperty(key, defaultValue));
    }
    ...
    public String getProperty(String key) {
        if (BizUtil.checkNull(key).equals(""))
            return "";
        return BizUtil.checkNull(properties.getProperty(key));
    }
}
