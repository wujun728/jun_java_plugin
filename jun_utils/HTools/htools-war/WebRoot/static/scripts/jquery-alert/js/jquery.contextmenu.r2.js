...
(function($) {
  ...
  var defaults = {
    ...
    eventPosY: 'pageY',
    //添加偏移量
    eventoffsetX:'offsetX',
    eventoffsetY:'offsetY',
  ...
  $.fn.contextMenu = function(id, options) {
    ...
    hash.push({
      ...
      eventoffsetX: options.eventoffsetX || defaults.eventoffsetX,
      eventoffsetY: options.eventoffsetY || defaults.eventoffsetY
    });
