...
public class FileInfo {
	 ...
	 */
	public FileInfo(boolean fetch_from_server, short file_type, long file_size, int create_timestamp, int crc32, String source_ip_addr) {
	...
	public String toString() {
		...
		return "fetch_from_server = " + this.fetch_from_server + ", " + "file_type = " + this.file_type + ", " + "source_ip_addr = " + this.source_ip_addr + ", " + "file_size = " + this.file_size + ", " + "create_timestamp = " + df.format(this.create_timestamp) + ", " + "crc32 = " + this.crc32;
	}
}
