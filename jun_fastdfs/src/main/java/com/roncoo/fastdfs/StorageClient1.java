...
/**
 * Storage client for 1 field file id: combined group name and filename Note: the instance of this class is NOT thread
 * safe !!! if not necessary, do NOT set storage server instance
 *
...
public class StorageClient1 extends StorageClient {
	...
	/**
	 * constructor with trackerServer and storageServer NOTE: if not necessary, do NOT set storage server instance
	 *
	 * @param trackerServer the tracker server, can be null
	 ...
	 *                  </ul>
	 *                  <ul>
	 *                  <li>ProtoCommon.STORAGE_SET_METADATA_FLAG_MERGE: merge, insert when the metadata item not exist,
