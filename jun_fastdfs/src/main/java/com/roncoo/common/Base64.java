 ...
 * Mark Thornton Optrak Distribution Software Ltd. http://www.optrak.co.uk and Kevin Kelley's
 ...
 * Java.net.URLEncoder.encode/decode If you don't like this code, there is another implementation at
 * http://www.ruffboy.com/download.htm Sun has an undocumented method called sun.misc.Base64Encoder.encode. You could
 * use hex, simpler to code, but not as compact.
 * <p>
 ...
 * <p>
 * version 1.4 2002 February 15 -- correct bugs with uneven line lengths, allow you to configure line separator. now
 * need Base64 object and instance methods. new mailing address. version 1.3 2000 September 12 -- fix problems with
 * estimating output length in encode version 1.2 2000 September 09 -- now handles decode as well. version 1.1 1999
 * December 04 -- more symmetrical encoding algorithm. more accurate StringBuffer allocation size. version 1.0 1999
 * December 03 -- posted in comp.lang.java.programmer. Futures Streams or files.
 */
...
public class Base64 {
	...
	/**
	 * 
	 * Encode an arbitrary array of bytes as Base64 printable ASCII. It will be broken into lines of 72 chars each. The last
	 * line is not terminated with a line separator. The output will always have an even multiple of data characters,
