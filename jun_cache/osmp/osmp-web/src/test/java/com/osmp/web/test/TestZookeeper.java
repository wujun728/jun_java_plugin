...
public class TestZookeeper {
	...
	public static final String NAME_SPACE = "/kaikai";
	...
	public static void main(String[] args) throws Exception {
		...
		// 注册连接监听事件
		zookeeper.registerListeners(client, "/kaikai");
		client.start();
		begin.await();
	}

	// 注册需要监听的监听者对像.
	private void registerListeners(CuratorFramework client, final String path) {
