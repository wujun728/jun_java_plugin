package com.jun.plugin.oauth.server.config;
...
import com.jun.plugin.oauth.server.domain.oauth.CustomJdbcClientDetailsService;
import com.jun.plugin.oauth.server.service.OauthService;
import com.jun.plugin.oauth.server.service.UserService;
import com.jun.plugin.oauth.server.web.oauth.OauthUserApprovalHandler;
