 ...
 * the License.
 */
package com.jun.plugin.workflow.jbpm;
...
import com.jun.plugin.workflow.HumanTaskApplicationTests;
...
public class LifeCycleBaseTest extends HumanTaskApplicationTests {

    private static final Logger logger = LoggerFactory.getLogger(LifeCycleBaseTest.class);

    @Autowired
    public InternalTaskService taskService;
