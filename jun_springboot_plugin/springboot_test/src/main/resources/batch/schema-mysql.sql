...
DROP TABLE IF EXISTS SPRING_BATCH_STEP_EXECUTION_CONTEXT ;
DROP TABLE IF EXISTS SPRING_BATCH_JOB_EXECUTION_CONTEXT ;
DROP TABLE IF EXISTS SPRING_BATCH_STEP_EXECUTION ;
DROP TABLE IF EXISTS SPRING_BATCH_JOB_EXECUTION_PARAMS ;
DROP TABLE IF EXISTS SPRING_BATCH_JOB_EXECUTION ;
DROP TABLE IF EXISTS SPRING_BATCH_JOB_INSTANCE ;

DROP TABLE IF EXISTS SPRING_BATCH_STEP_EXECUTION_SEQ ;
DROP TABLE IF EXISTS SPRING_BATCH_JOB_EXECUTION_SEQ ;
DROP TABLE IF EXISTS SPRING_BATCH_JOB_SEQ ;
...
CREATE TABLE SPRING_BATCH_JOB_EXECUTION  (
	...
	references SPRING_BATCH_JOB_INSTANCE(JOB_INSTANCE_ID)
) ENGINE=InnoDB;
...
CREATE TABLE SPRING_BATCH_JOB_EXECUTION_PARAMS  (
	...
	references SPRING_BATCH_JOB_EXECUTION(JOB_EXECUTION_ID)
) ENGINE=InnoDB;
...
CREATE TABLE SPRING_BATCH_STEP_EXECUTION_CONTEXT  (
	...
	references SPRING_BATCH_STEP_EXECUTION(STEP_EXECUTION_ID)
) ENGINE=InnoDB;
