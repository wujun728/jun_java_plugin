...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/login/zice.style.css">
	<link rel="stylesheet" type="text/css" href="css/login/tipsy.css">
	<link rel="stylesheet" type="text/css" href="css/login/icon.css">
	<link rel="stylesheet" type="text/css" href="css/login/buttons.css">
	<script type="text/javascript" src="js/login/iphone.check.js"></script>
	<script type="text/javascript" src="js/login/jquery-jrumble.js"></script>
	<script type="text/javascript" src="js/login/jquery.tipsy.js"></script>
...
margin-left: 88px;
  ...
  <body>
	...
	<div class="text_success">
		<img src="css/extend/loader_green.gif" alt="Please wait" /> 
		<span>登陆成功!请稍后....</span>
	</div>
	<div id="login">
<!-- 		<div class="ribbon"></div> -->
<!-- 		<div class="ribbon" style="background-image:url(css/extend/typelogin.png);"></div> -->
		<div class="inner">
			<div class="logo">
<!-- 				<img src="css/extend/toplogo.gif" /> -->
				<img src="css/extend/toplogo-jeecg.png" />
			</div>
			<div class="formLogin">
				<form name="formLogin" action="systemController.do?method=load" id="formLogin" method="post">
	...
	<div class="clear"></div>
	<div id="versionBar">
		<div class="copyright">&copy; 版权所有 <span class="tip"><a href="javascript:void(0);" title="sysErp">JUN</a>
				(推荐使用IE9+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="javascript:void(0);" title="sysErp">JUN</a> </span>
		</div>
	</div>
</body>
</html>
