package com.jun.plugin.captcha;

import org.junit.Test;

import com.jun.plugin.captcha.ArithmeticCaptcha;
import com.jun.plugin.captcha.ChineseCaptcha;
import com.jun.plugin.captcha.ChineseGifCaptcha;
import com.jun.plugin.captcha.GifCaptcha;
import com.jun.plugin.captcha.SpecCaptcha;
...
public class CaptchaTest {
    ...
    public void testGIf() throws Exception {
        for (int i = 0; i < 10; i++) {
            ...
            gifCaptcha.out(new FileOutputStream(new File("D:/Java/bb" + i + ".gif")));
        }
    }
    ...
    public void testHan() throws Exception {
        for (int i = 0; i < 10; i++) {
            ...
            chineseCaptcha.out(new FileOutputStream(new File("D:/Java/cc" + i + ".png")));
        }
    }
    ...
    public void testGifHan() throws Exception {
        for (int i = 0; i < 10; i++) {
            ...
            chineseGifCaptcha.out(new FileOutputStream(new File("D:/Java/dd" + i + ".gif")));
        }
    }
    ...
    public void testArit() throws Exception {
        for (int i = 0; i < 10; i++) {
            ...
            specCaptcha.out(new FileOutputStream(new File("D:/Java/ee" + i + ".png")));
        }
    }
