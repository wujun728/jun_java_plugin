...
<body>
<form action="<c:url value="/userAction/doUpdate"/>" method="post">
	...
	<div id="main">
      ...
      <div class="sort_switch">
          <ul id="TabsNav">
          	  <li class="selected"><a href="#">更新用户</a></li>
          </ul>
      </div>
                	...
                	<table class="tableHue2" width="100%" border="1" bordercolor="#dddddd" cellspacing="0" cellpadding="0">
                      <tbody>
                        <tr>
                          ...
                          <td class="left"><input name="name" type="text" value="${user.name }" class="input_text2" size="30" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                        	<td width="15%" class="title1">锁定：</td>
                          	<td class="left">
                          		是：<input name="locked" type="radio" value="1" ${user.locked == 1?'checked':'' } />
                          		否：<input name="locked" type="radio" value="0" ${user.locked == 0?'checked':'' }/>
                          	</td>
                        </tr>
                      </tbody>
                  </table>
