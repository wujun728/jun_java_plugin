...
import com.xxl.apm.admin.core.model.XxlCommonRegistry;
...
import com.xxl.apm.admin.core.util.PropUtil;
import com.xxl.apm.admin.dao.IXxlCommonRegistryDao;
import com.xxl.apm.admin.dao.IXxlCommonRegistryDataDao;
import com.xxl.apm.admin.dao.IXxlCommonRegistryMessageDao;
import com.xxl.apm.admin.service.XxlCommonRegistryService;
...
public class XxlCommonRegistryServiceImpl implements XxlCommonRegistryService, InitializingBean, DisposableBean {
    ...
    public String setFileRegistryData(XxlCommonRegistry xxlCommonRegistry){
        ...
        logger.info(">>>>>>>>>>> xxl-apm, setFileRegistryData: key={}, data={}", xxlCommonRegistry.getKey(), xxlCommonRegistry.getData());
    ...
    public void filterChildPath(File parentPath, final List<String> registryDataFileList){
        ...
        for (File childFile: childFileList) {
            if (childFile.isFile() && !registryDataFileList.contains(childFile.getPath())) {
                ...
                logger.info(">>>>>>>>>>> xxl-apm, cleanFileRegistryData, RegistryData Path={}", childFile.getPath());
            }
