...
@DubboService
@Slf4j
public class DeptProviderServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements DeptProviderService {
    ...
    public void deleted(String id) {
        ...
        List<SysUser> list = userProviderService.getUserListByDeptIds(deptIds);
